...
return {
  ...
  -- Description: A Neovim plugin for cmdline (and others)
  {
    "folke/noice.nvim",
    opts = {
      -- cmdline = {
  ...
  -- Description: A Neovim plugin for distraction-free coding.
  {
    ...
    opts = {
      ...
      plugins = {
        ...
        gitsigns = { enabled = true }, -- Enable gitsigns integration
        tmux = { enabled = true }, -- Enable tmux integration
        todo = { enabled = false }, -- Disable todo-comments integration
        wezterm = { enabled = true, font = "+2" }, -- Enable wezterm integration with increased font size
      },
    },
